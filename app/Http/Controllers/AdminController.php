...
class AdminController extends Controller
{
    ...
    public function getAdmin()
    {
            ...
            // print_r($user);
            // echo '</pre>';
            return view('admin.adminDashBoard', ['user' => $user, 'exam' => $exam, 'quest' => $quest, 'report' => $report]);
        
    }
    public function getUserAdmin()
    {
        $user = User::get();
        return view('admin.adminUser', ['user' => $user, 'i' => 1]);
    }
    public function getExamAdmin()
    {
        ...
        return view('admin.adminExam', ['exam' => $exam, 'i' => 1]);
    }
    public function getQuestionAdmin()
    {
        ...
        return view('admin.adminQuestion', ['quest' => $quest, 'i' => 1]);
    }
    public function getScoresAdmin()
    {
        ...
        return view('admin.adminScores', ['scores' => $scores, 'i' => 1]);
    }
    public function getReportAdmin()
    {
        ...
        return view('admin.adminReport', ['report' => $report, 'i' => 1]);
    }
}
