				...
				$("#answer_body_" + i).append($(`<div class="form-group row showcase_row_area" id="${'answer_' + i + '_' + number_question_answer[i].pop()}">
                                    ...
                                    <div class="col-sm-1 btn-group btn-group-vertical text-center" data-toggle="buttons">
                                        <label class="btn active">
                                            <input type="radio" name=${'question[' + i + '][2]'} 
											value=${String.fromCharCode(number_question_answer[i][number_question_answer[i].length - 1].charCodeAt(0) - 1)} 
											id=${'check' + i + String.fromCharCode(number_question_answer[i][number_question_answer[i].length - 1].charCodeAt(0) - 1)}>
